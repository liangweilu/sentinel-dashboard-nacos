...
/**
 * 基于{@link com.alibaba.csp.sentinel.dashboard.controller.DegradeController} 改造
 * 数据的获取和存储从nacos取
 *
...
public class DegradeControllerV2 {
    ...
    public Result<DegradeRuleEntity> apiAddRule(@RequestBody DegradeRuleEntity entity) {
        ...
        try {
            ...
            logger.error("Publish degrade rules failed, app={}", entity.getApp(), e);
    ...
    public Result<Long> delete(@PathVariable("id") Long id) {
        ...
        try {
            ...
            logger.error("Publish degrade rules failed, app={}", oldEntity.getApp(), e);
            throw new RuntimeException(e);
        }
